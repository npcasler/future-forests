...
Forests.Method.FIXTURES = [{
  id: 1,
  detail: '<div style=\"\"><p style=\"margin-top:150px !important;\">Climatic suitability was modeled using 1) occurrence data derived from the Botanical Information and Ecology Network(<a href=\"http://bien.nceas.ucsb.edu/bien\">BIEN</a>), 2) digital maps of climate, and 3) a statistical model to associate these two types of information.</p></div>',
  detailId: 'a-intro'
}, {
  id: 2,
