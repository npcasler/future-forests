...
Forests.Headline.FIXTURES = [{
 ...
 id: 2,
  ...
  orderId: 'g',
  pageId: 'climate',
  detail: "<p class=\"leftAlign\">With increased concentrations of greenhouse gas emissions will come warmer temperatures and drought. These changes will put western forests increasingly at risk of higher-than-normal rates of tree mortality, and ultimately, reduction of the area that is climatically-suitable for forests. For many tree species, the most climatically-suitable areas will shift from their current locations, increasing vulnerability to insects, disease, and fire in areas that become unsuitable.</p><div class=\"bottom-nav\"><div class=\"circle-nav\">Greenhouse<br>Gas Emissions</div><div class=\"greenArrow-bottom\">&nbsp;</div><div class=\"circle-nav\">Climate<br>Change</div><div class=\"greenArrow-bottom\">&nbsp;</div><div class=\"circle-nav-active\"><a href=\"#/headlines/forest\">Forest<br>Loss</a></div></div></p>"
}, {
  id: 8,
  title: 'Citations',
...
//  detail: "<h3>Societal choices for greenhouse gas emissions will have consequences for our Western forests, including what our landscapes and backyards look like. Here we summarize what these consequences are, based on our own forecasts and the consensus in the scientific literature.</h3>"
  ...
  orderId: 'p',
  pageId: 'forest',
  detail: " <p class=\"textMd\">These  forecasts are supported by large-scale die-offs that we are witnessing today  [lodgepole pine, pinon, aspen].</p> <div class=\"col-md-4\"> <ul style=\"text-align: left\"> <li><h4><a href=\"http://en.wikipedia.org/wiki/Abies_lasiocarpa\">Subalpine fir, <em>Abies lasiocarpa</em></a></h4> <div class=\"abies_range\"></div></li> <li><h4><a href=\"http://en.wikipedia.org/wiki/Picea_engelmannii\">Engelmann Spruce, <em>Picea engelmannii</em></a></h4> <div class=\"eng-range\"></div> </li> <li><h4><a href=\"http:/en.wikipedia.org/wiki/Pinus_contorta\">Lodgepole pine, <em>Pinus contorta</em></a></h4> <div class=\"cont-range\"></div> </li> </ul> </div> <div class=\"col-md-4\"> <ul style=\"text-align: left\"> <li><h4><a href=\"http://en.wikipedia.org/wiki/Pinus_aristata\">Rocky Mountain maple, <em>Acer glabrum</em></a></h4> <div class=\"glab-range\"></div> <li><h4><a href=\"http://en.wikipedia.org/wiki/Pinus_ponderosa\">Ponderosa pine, <em>Pinus ponderosa</em></a></h4> <div class=\"ponderosa-range\"></div> </li> <li><h4><a href=\"http://en.wikipedia.org/wiki/Pinus_jeffreyi\">Jeffrey pine, <em>Pinus jeffreyi</em></a></h4> <div class=\"jeffrey-range\"></div> </li> </ul> </div> <div class=\"col-md-4\"> <ul style=\"text-align: left;\"> <li><h4><a href=\"http://en.wikipedia.org/wiki/Pinus_edulis\">Pinyon pine, <em>Pinus edulis</em></a></h3> <div class=\"pinyon-range\"></div> </li> <li><h4><a href=\"http://en.wikipedia.org/wiki/Douglas_fir\">Douglas-fir, <em>Pseudotsuga menziesii</em></a></h4> <div class=\"menziesii-range\"></div> </li> <li><h4><a href=\"http://en.wikipedia.org/wiki/Tsuga_heterophylla\">Western hemlock, <em>Tsuga heterophylla</em></a></h4> <div class=\"hetero-range\"></div> </li> </ul> <p>&nbsp;</p></div>"
}, {
  id: 17,
  ...
  orderId: 's',
  pageId: 'forest',
  detail: "<div class=\"row\"><div class=\"col-md-4\"><p class=\"leftAlign\">Certain trees in arid forests of the Southwest and central Rocky Mountains are also expected to experience dramatic declines. The charts shows the change in area that is climatically-suitable for 23 tree species characteristc of arid forests in the western U.S. Each line represents a different species. Ponderosa pine (#66) and pinyon pine (#58) are some of the species forecast to decline dramatically.</p></div><div class=\"col-md-8\"><div class=\"row\"><div class=\"arid26\"></div><div class=\"arid85\"></div></div><p>Anything???</p></div></div>"
}, {
  id: 20,
