...
Forests.Headline.FIXTURES = [{
 ...
 id: 2,
  ...
  orderId: 'e',
  pageId: 'climate',
  detail: " <div class=\"col-md-6 leftAlign\"><p>In addition to the drought stress caused by rising temperatures, the newest climate change predictions indicate that there will be less precipitation in the winter-spring in the Southwest and a stronger summer drought in the Pacific Northwest. The map shows anticipated seasonal precipitation change for 2071-2099, compared to 1970-1999. Under the worst-case scenario (RCP 8.5), large reductions in winter and spring precipitation are forecast for the Southwest. Rapid emissions reductions would be required for the modest changes in the best-case scenario (RCP 2.6) &#8212; more than 70% cuts from current levels by 2050. Hatched areas indicate that the projected changes are significant and consistent among models. White areas indicate that the changes are not projected to be larger than could be expected from natural variability.</p></div> <div class=\"col-md-6\"><p class=\"textMd\">Seasonal Precipitation Change</p><div class=\"precip-change figure\"></div><br><em>Seasonal precipitation change.</em> Figure source: NOAA NCDC / CICS-NC. Graph and legend from <a href=\"http://nca2014.globalchange.gov/report/our-changing-climate/precipitation-change#graphic-16689\">NCA</a></p></div>"
...
//  detail: "<h3>Societal choices for greenhouse gas emissions will have consequences for our Western forests, including what our landscapes and backyards look like. Here we summarize what these consequences are, based on our own forecasts and the consensus in the scientific literature.</h3>"
  ...
  orderId: 'm',
  pageId: 'forest',
  detail: " <div class=\"col-md-4\"><p class=\"leftAlign\">Forest loss will be influenced by the pace of greenhouse gas emissions. The worst-case emissions scenario (RCP 8.5) will reduce the area climatically suitable for dominant forest species by up to 40% (red line). In contrast, the best-case climate change scenario (RCP 2.6) will reduce the area suitable for these species by only 15-20% (blue line).</p> </div><div class=\"col-md-8\"><p class=\"textMd\">Trajectory of total area covered by forest species</p><div class=\"forest-cover\"></div> <p>Change through time in the area climatically-suitable for 52 Western U.S. tree species.</p></div>"
}, {
  id: 14,
