Forests.Headline = DS.Model.extend({
  ...
  figureContainer: function() {
   ...
   mountainName: function() {
    return this.get('mountain') + '-names';
  }.property('mountain'),

  mountainContainer: function() {
    return this.get('mountain') + '-container';
  }.property('mountain'),

  mountainBest: function() {
    return this.get('mountain') + '-best';
  }.property('mountain'),
  mountainWorst: function() {
    return this.get('mountain') + '-worst';
  }.property('mountain'),

  combinedContainer: function() {
    return this.get('mountain') + '-combined';
  }.property('mountain'),
...
Forests.Headline.FIXTURES = [{
  ...
  orderId: 'a',
  pageId: 'climate',
  detail: "<div class=\"col-md-6 textSm leftAlign\"><p>Human activities are the primary cause of global warming over the past 50 years. The release of greenhouse gases from fossil fuels has increased the concentration of carbon dioxide in the atmosphere by more than 40% since the Industrial Revolution. Scientists have known for more than 200 years that carbon dioxide traps heat in our atmosphere. The pattern of temperature change in the atmosphere - warming near the surface vs. cooling in upper levels - confirms that the buildup of greenhouse gases has caused most of the Earth's warming over the past century.</p> <p>The chart shows the increase of both atmospheric carbon dioxide (CO<sub>2</sub>) and global annual average temperature since 1880. The black line is CO<sub>2</sub> concentration, in parts per million. The red bars show temperatures above the long-term average, and blue bars indicate temperatures below the long-term average. Global annual average temperature (as measured over both land and oceans) has increased by more than 1.5&#176;F(0.8&#176;C) since 1880 (through 2012).</p> <p>&nbsp;</p></div><div class=\"col-md-6\"><p class=\"textMd\">Global Temperature and Carbon Dioxide</p><div class=\"global-temp-and-co2 figure\"></div> <p><em>Global Temperature and Carbon Dioxide</em></strong>    Figure source: <a target=\"_blank\" href=\"http://nca2014.globalchange.gov/report/our-changing-climate/observed-change#graphic-16678\">NCA</a> updated from Karl et al. 2009.</p></div>"
}, {
 ...
 id: 2,
  ...
  orderId: 'd',
  pageId: 'climate',
  detail: "<div class=\"col-md-6 textSm leftAlign\"><p>With increasing temperatures, less precipitation comes in the form of snow, and snow melts earlier. Melting snow normally releases water slowly in spring and summer, when both natural ecosystems and people have the greatest need for water. This is key to the functioning of certain forests in the western U.S., and in particular to the Southwest's hydrology and water supplies. Less snow, and earlier snowmelt, means that both natural and human communities will face water shortages.</p><p>The map shows projected snow water equivalent (SWE), the amount of water held in a volume of snow, for the Southwestern states, as a percentage of 1971-2000, under the worst-case emissions scenario (RCP 8.5). Declines in peak SWE are strongly correlated with early timing of runoff and decreases in total runoff. For watersheds that depend on snowpack like the Sierra Nevada, and the Upper Colorado and Upper Rio Grande River basins, lower SWE also translates to reduced reservoir water. The size of bars is proportional to the amount of snow each state contributes to the regional total.</p></div> <div class=\"col-md-6\"><p class=\"textMd\">Projected Snow Water Equivalent</p><div class=\"snow_water figure\"></div> <p><br><em>Projected Snow Water Equivalent</em><br> Data from Scripps Institution of Oceanography. Graphic and legend from <a target=\"_blank\" href=\"http://nca2014.globalchange.gov/report/regions/southwest#narrative-page-17097\">NCA</a></p></div>"
}, {
  ...
  orderId: 'e',
  pageId: 'climate',
  detail: " <div class=\"col-md-4 textSm leftAlign\"><p>In addition to the drought stress caused by rising temperatures, the newest climate change predictions indicate that there will be less precipitation in the winter-spring in the Southwest and a stronger summer drought in the Pacific Northwest. The map shows anticipated seasonal precipitation change for 2071-2099, compared to 1970-1999. Under the worst-case scenario (RCP 8.5), large reductions in winter and spring precipitation are forecast for the Southwest. Rapid emissions reductions would be required for the modest changes in the best-case scenario (RCP 2.6) &#8212; more than 70% cuts from current levels by 2050. Hatched areas indicate that the projected changes are significant and consistent among models. White areas indicate that the changes are not projected to be larger than could be expected from natural variability.</p></div> <div class=\"col-md-8\"><p class=\"textMd\">Seasonal Precipitation Change</p><div class=\"precip-change figure\"></div><p class=\"textSm\">Precipitation Change (%)</p><div class=\"precip-change-legend figure\"></div><br><em>Seasonal precipitation change.</em> Figure source: NOAA NCDC / CICS-NC. Graph and legend from <a target=\"_blank\" href=\"http://nca2014.globalchange.gov/report/our-changing-climate/precipitation-change#graphic-16689\">NCA</a></p></div>"
...
//  detail: "<h3>Societal choices for greenhouse gas emissions will have consequences for our Western forests, including what our landscapes and backyards look like. Here we summarize what these consequences are, based on our own forecasts and the consensus in the scientific literature.</h3>"
  ...
  orderId: 'm',
  pageId: 'forest',
  detail: " <div class=\"col-md-4\"><p class=\"leftAlign textSm\">The total coverage of forest in the western United States will be influenced by the place of greenhouse gas emissions. The graph on the right shows how climate change will reduce the total area suitable for forest. By the year 2080, under the worst-case emissions scenario (RCP 8.5), the are climatically suitable for dominant forest species will be reduced by up to 40% (red line). In contrast, under best-case climate change scenario (RCP2.6), by 2080 the area suitable for forest will be reduced byt only by 15-20% (blue line).</p> </div><div class=\"col-md-8\"><p class=\"textMd\" style=\"margin-left:20%;\">Trajectory of total area covered by forest species</p><div class=\"forest-cover\"></div> <p style=\"margin-left:20%;\">Change through time in the area climatically-suitable for 52 Western U.S. tree species.</p></div>"
}, {
  id: 14,
  ...
  orderId: 'n',
  pageId: 'forest',
  detail: "<div class=\"row\"><div class=\"col-md-12 leftAlign textSm\"><p>The animated forest simulations below show the area climatically-suitable for nine dominant tree species that make up the majority of trees in the SOuthern Rocky Mountains. These images are derived from the Outerra climate change simulator.</p><p>The first simulation is viewd from the perspective of the upper atmosphere. Forested areas are dark green. Compare the forested dark green area in the left-most image (current) to the right-most image (worst-case future, RCP 8.5). Note, by 2080, there is a dramatic loss of area climatically suitable for forest throughout the southern Rocky Mountains, the Mogollon Rim area of northern Arizona, and southern Utah. Less forest cover is lost under the best-case climate change scenario (RCP 2.6, middle image).</p><p>The second simulation is viewed from the lower atmosphere looking north, north-west over central Colorado. Forested areas of Utah and Wyoming are also visible. The forested areas are dark green. Compare the forested dark green area in the left-most image (current) to the right-most image (worst-case future, 2080 RCP 8.5). Note, there is a dramatic loss of area climatically suitable for forest especially in more western locations.</p></div></div><p>&nbsp;</p>",
  mountain: 'global',
}, {
  id: 15,
  ...
  orderId: 'o',
  pageId: 'forest',
  detail: "<p class=\"leftAlign textSm\">Forest loss caused by changing climate will affect what our backyards and landscapes look like. Here we offer current vs. future views of three locations in the western U. S. under the best-case climate scenarioi (RCP 2.6) vs. the worst-case climate change scenario (RCP 8.5). These views were generated by the Outerra climate change simulator.</p>",
  mountain: 'local',
  local: 'y',
  mountainTitle: 'y',
},{
  id: 16,
  title: 'Many tree species predicted to decline include high-elevation species, commercially-important species, and other...',
  classId: 'summary-elev',
  orderId: 'p',
  pageId: 'forest',
  detail: " <p class=\"textMd\">Click on a species below to see its forecast change in climatically suitable area. Each species forecast includes the area climatically suitable for each species under the worst-case emissions scenario (RCP 8.5), and the best-case climate change scenario (RCP 2.6). These forecasts area supported by large-scale die-offs that we are witnessing today (see the NCA Forest link <a target=\"_blank\" href=\"http://nca2014.globalchange.gov/report/sectors/forests\">http://nca2014.globalchange.gov/report/sector/forests</a>)</p>",
  chart: 'loss',
  loss: 'y'
}, {
  id: 17,
  ...
  orderId: 'q',
  pageId: 'forest',
  detail: "<div class=\"row\"><div class=\"col-md-6 textSm\"><p class=\"leftAlign\">The speed of this shift in area climatically suitable for forests will be affected by how much greenhouse gases we choose to emit over the next 10-20 years.</p><p class=\"leftAlign\">The chart shows this shift in elevation for one species, Aspen (<i>Populus tremuloides</i>). Both panels show aspne's predicted elevation distribution in ten-year time slices (colored lines), from YEAR to YEAR. On the top is the best-case scenario: a noticeable upslope shift during the fist decade, that stabilizes by the end of the century. On the bottom is the worst-case scenario: a consisten march upwords in elevation each decade, that will translate into less nd less area suitable for this species.</p><p>&nbsp;</p></div><div class=\"col-md-6\"><p class=\"textMd\">Elevation shift in area suitable for Aspen - Best-case scenario</p><div class=\"elev26 centerAlign\"></div><p>&nbsp;</p><p class=\"textMd\">Elevation shift in area suitable for Aspen - Worst-case scenario</p><div class=\"elev85 centerAlign\"></div><p>&nbsp;</p><p class=\"centerAlign\">Change in elevation for aspen (<em>Populus tremuloides</em>) under best- vs worst-case scenarios.</p></div></div>"
}, {
  id: 18,
  ...
  orderId: 'aa',
  pageId: 'about',
  detail: '<div class=\"row textMd\"><div class=\"centerAlign about-padding\"><h1>About ForestForecasts.org</h1><h2><em>What will happen to our forests in 20 or 100 years from now?</em></h2><h2><em>What will your backyard look like with increasing changes in climate?</em></h2><h2><em>How will changes in greenhouse gas emissions influence out forests?</em></h2><p style="padding-top:3%;">Within our lifetime, forests are going to change. But how much they will change is up to us. Forests may experience dramatic reductions in cover and enhanced <em>mortality</em> events ultimately due to increased drought and changing temperatures.</p><p>ForestForecasts.org allows you to explore current and futuremaps and similations. It uses the largest compilation of forest data, the most recent science forecasts, and new <em>tools</em> to visualize future forecasts for our forests and landscapes.</p><p>Learn about the <a href=\"https://www.aspennature.org/about\" class=\"aces-link\">Aspen Center for Environmental Studies</a></p></div><div class="row"><h1><ul id="about-list"><li class="about-li">Why?</li><li>-</li><li class="about-li">What?</li><li>-</li><li class="about-li">How?</li><li>-</li><li class="about-li">Who?</li></ul></div></h1></div>'
},{
  id: 33,
  ...
  orderId: 'ac',
  pageId: 'about',
  detail: '<div class=\"row textMd centerAlign about-padding\"><h1>What is ForestForecasts.org?</h1><p>ForestForecasts.org allows you to access and use interactive maps and forecasts - animated \'weather channel-like\' forecasts at local, landscape, and regional levels.</p></div>',
},{
  id: 35,
  ...
  orderId: 'ae',
  pageId: 'about',
  detail: '<div class=\"row textMd centerAling about-padding\"><h1>Who is ForestForecasts.org?</h1><p id=\"who-links\">We are a collaberative group of scientists, educators, informaticians, and public outreach practitioners. ForestForecasts.org is directed by <a target=\"_blank\" href=\"https://brianjenquist.wordpress.com/\">B.J. Enquist</a> at the University of Arizona/Santa Fe Institute and the <a target=\"_blank\" href=\"https://www.aspennature.org/\">Aspen Center for Environmental Studies</a>. Core project collaborators include Nathan Casler, Margaret Evans, Jamie Cundif, Chris Lane, Noah Charney, Martha Narro, and Francina Dominguez. Computational and data collaborators include <a target=\"_blank\" href=\"http://www.iplantcollaborative.org/\">iPlant</a>, <a target=\"_blank\" href=\"https://www.nceas.ucsb.edu/\">NCEAS</a>, <a target=\"_blank\" href=\"http://www.outerra.com/\">Outerra</a>, <a target=\"_blank\" href=\"http://ltrr.arizona.edu/\">The Tree Ring Labratory</a>, and <a target=\"_blank\" href=\"http://bien.nceas.ucsb.edu/bien/\">BIEN</a>. Project support and advising - Chris Lane and Jerry Murdock.</p></div><div class=\"row\"><div class=\"aces\"></div><div class=\"iplant\"></div><div class=\"ua\"></div><div class=\"ltrr\"></div><div class=\"bien\"></div><div class=\"nceas\"></div><div class=\"usgist\"></div><div class=\"sfi\"></div></div>'
},{
  id: 37,
