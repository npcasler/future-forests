...
Forests.Headline.FIXTURES = [{
  ...
  orderId: 'a',
  pageId: 'climate',
  detail: "<div class=\"col-md-6\"> <p>Human activities are the primary cause of global warming over the past 50 years. The release of greenhouse gases from fossil fuels has  increased the concentration of carbon dioxide in the atmosphere by more that 40% since the Industrial Revolution. Scientists  have known for more than 200 years that carbon dioxide traps heat in our atmosphere.  The pattern of temperature change in the atmosphere - warming near the surface vs. cooling  in upper levels of the atmosphere - confirms that the buildup of greenhouse gases has caused most of the Earth's warming over the past century.</p> <p>Figure 1 shows the increase of both atmospheric carbon dioxide (CO2)  and global annual average temperature since 1880. The black line is CO2 concentration, in parts per million. The red bars show temperatures above the long-term average, and blue bars indicate temperatures below the long-term average. Global annual average temperature (as measured over both land and oceans) has increased by more than 1.5&#176;F(0.8&#176;C) since 1880 (through 2012).</p> <p>&nbsp;</p></div><div class=\"col-md-6\"> <div class=\"global-temp-and-co2 figure\"></div> <p><strong>Figure 1 legend - <em>Global Temperature and Carbon Dioxide</em></strong>    Figure source: <a href=\"http://nca2014.globalchange.gov/report/our-changing-climate/observed-change#tab1-images\">NCA</a> updated from Karl et al. 2009 <super>1</super>.</p></div>"
}, {
  id: 2,
  ...
  orderId: 'b',
  pageId: 'climate',
  detail: "<p> Certain types of extreme weather events with links to climate change have become more frequent and/or intense, including prolonged periods of heat, heavy downpours, and, in some regions, floods and droughts. In addition, warming is causing sea levels to rise and glaciers and Arctic sea ice to melt. Oceans are becoming more acidic as they absorb carbon dioxide. These aspects of climate change are disrupting people's lives and damaging sectors of our economy.</p>"
}, {
  id: 3,
  ...
  orderId: 'h',
  pageId: 'climate',
  detail: " <div class=\"col-md-6\"><p> The newest climate change predictions indicate that western forests  will be drier and experience increased drought,  largely driven by increasing temperatures, but also by less precipitation in the winter-spring in the Southwest and a stronger summer drought in the Pacific Northwest. Figure 5 shows anticipated seasonal precipitation change  for 2071-2099(compared to 1970-1999). Under the worst-case scenario (RCP 8.5), large reductions in winter and spring precipitation are forecast for the Southwest. Rapid emissions reductions would be required for the modest changes in the best-case scenario (RCP 2.6) &#8212; more than 70% cuts from current levels by 2050. Hatched areas indicate that the projected changes are significant and consistent among models. White areas indicate that the changes are not projected to be larger than could be expected from natural variability.</p></div> <div class=\"col-md-6\"> <div class=\"avg_precip figure\"><br> </div> <div class=\"precip-change figure\"></div><br> <strong>Figure 5 Legend &#8212;</strong> Seasonal precipitation change.    Figure source: NOAA NCDC / CICS-NC. Graph and legend from <a href=\"http://nca2014.globalchange.gov/report/our-changing-climate/precipitation-change\">NCA</a></p></div>"
  ...
  orderId: 'm',
  pageId: 'forest',
  detail: " <div class=\"col-md-6\"><p>Forest loss will be influenced by the pace of greenhouse gas emissions. The worst-case emissions scenario (RCP 8.5) will reduce the area climatically suitable for dominant forest species by up to 40% (Figure 1, red line). In contrast, the best-case climate change scenario (RCP 2.6) will reduce the area suitable for these species by only 15-20% (Figure 1, blue line).</p> </div><div class=\"col-md-6\"><div class=\"forest-cover figure\"></div> <p><strong>Figure 1 Legend &#8212;</strong> Change through time in the area climatically-suitable for 52 Western U.S. tree species.  </p></div>"
}, {
  id: 14,
  ...
  orderId: 'n',
  pageId: 'forest',
  detail: " <div class=\"row\"><p>The area climatically-suitable for nine dominant species in the state of Colorado is shown from the perspective of the upper atmosphere. The loss of forested area is most striking by comparing the current distribution  to the worst-case climate change scenario (RCP 8.5). Less forest cover is lost under the best-case climate change scenario (RCP 2.6). These images are derived from the Outerra climate change simulator.</p> <div class=\"col-md-4\"> <h3>Current</h3> <div class=\"atmo-current figure\"></div></div> <div class=\"col-md-4\"> <h3>Best-case climate change</h3> <div class=\"atmo-rcp26 figure\"></div></div> <div class=\"col-md-4\"> <h3>Worst-case climate change</h3> <div class=\"atmo-rcp85 figure\"></div></div></div>"
}, {
  id: 15,
  ...
  orderId: 'o',
  pageId: 'forest',
  detail: "  <p>Forest loss caused by changing climate will affect what our backyards and landscapes look like. Here we offer current vs. future views of three locations in the western U. S. under the best-case climate scenario(RCP 2.6) vs. the worst-case climate change scenario(RCP 8.5). These views were generated by the Outerra climate change simulator.</p> <div class=\"row\"><div class=\"col-md-4\"><h3>Current</h3></div><div class=\"col-md-4\"><h3>Best-Case Climate Change</h3></div><div class=\"col-md-4\"><h3>Worst-Case Climate Change</h3></div></div><h3>Aspen</h3><div class=\"row\"> <div class=\"col-md-4\"> <div class=\"aspen-current\"></div> </div> <div class=\"col-md-4\">  <div class=\"aspen26\"></div> </div> <div class=\"col-md-4\"> <div class=\"aspen85\"></div> </div> </div> <h3>Mt. Lemmon</h3><div class=\"row\"><div class=\"col-md-4\"><div class=\"lemmon-current\"></div></div><div class=\"col-md-4\"> <div class=\"lemmon-26\"></div> </div> <div class=\"col-md-4\"> <div class=\"lemmon-85\"></div> </div> </div> <h3>Crested Butte</h3><div class=\"row\"><div class=\"col-md-4\"><div class=\"butte-current\"></div></div><div class=\"col-md-4\"><div class=\"butte-26\"></div></div><div class=\"col-md-4\"><div class=\"butte-85\"></div></div></div><p><strong>Figure 8 Legend &#8212;</strong> Projected landscape views of nine dominant Rocky Mountain forest species on the upper elevation slopes of Mt. Lemmon, near Tucson, Arizona. Here, using the Outerra landscape and vegetation visualizing platform, two different climate change scenarios are shown, contrasting the reduction of forested area and shifting the remaining forest at the highest elevation of Mt. Lemmon.</p> <p>&nbsp;</p> <div class=\"movie1\"></div><iframe src=\"//player.vimeo.com/video/107734991\" width=\"500\" height=\"281\" frameborder=\"0\" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> <p><strong>Movie 1 Legend &#8212;</strong>View of Aspen CO, looking South, with predicted change in the climatic suitability of the landscape for aspen trees (Populus tremuloides) through time. These animations use our Future Forest Distribution Model to show what happens to the climate conditions aspen requires to be successful at 10-year intervals &#8212; from the current climate to future climates ending in the year 2081 &#8212; under the best-case emissions scenario vs. the worst-case emissions scenario. Darker green regions on the landscape correspond to good conditions for aspen trees, whereas light green grading into white regions, indicate poor conditions for aspen. In the worst-case climate change scenario, most of the area around Aspen, CO is unlikely to be climatically suitable for aspen trees. However, in the best case scenario the reduction in suitability slows by the end of the century.</p> "
}, {
  id: 16,
